...
module.exports = class extends Generator {
  ...
  writing() {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(path.join(this.destinationRoot(), '.github/ISSUE_TEMPLATE.md')),
      {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(path.join(this.destinationRoot(), '.github/pull_request_template.md')),
      {
        'projectName': this.props.projectName
      }
    )
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(path.join(this.destinationRoot(), 'docs/authors.rst'))
    )
    this.fs.copyTpl(
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(path.join(this.destinationRoot(), 'docs/history.rst'))
    )
    this.fs.copyTpl(
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(path.join(this.destinationRoot(), 'docs/installation.rst')),
      {
        'projectName': this.props.projectName,
    ...
    //cp requirements folder
    this.fs.copyTpl(
      this.templatePath('requirements/dev.txt'),
      this.destinationPath(path.join(this.destinationRoot(), 'requirements/dev.txt'))
    )
    this.fs.copyTpl(
      this.templatePath('requirements/prod.txt'),
      this.destinationPath(path.join(this.destinationRoot(), 'requirements/prod.txt'))
    )
    this.fs.copyTpl(
      this.templatePath('requirements/test.txt'),
      this.destinationPath(path.join(this.destinationRoot(), 'requirements/test.txt'))
    )

    // cp stests folder
    this.fs.copyTpl(
      this.templatePath('stests/__init__.py'),
      this.destinationPath(path.join(this.destinationRoot(), 'stests/__init__.py'))
    )
    this.fs.copyTpl(
      this.templatePath('stests/common_resources.robot'),
      this.destinationPath(path.join(this.destinationRoot(), 'stests/common_resources.robot'))
    )
    this.fs.copyTpl(
      this.templatePath('stests/default_suite.robot'),
      this.destinationPath(path.join(this.destinationRoot(), 'stests/default_suite.robot'))
    )

    // cp utest folder
    this.fs.copyTpl(
      this.templatePath('utests/__init__.py'),
      this.destinationPath(path.join(this.destinationRoot(), 'utests/__init__.py'))
    )
    this.fs.copyTpl(
      this.templatePath('utests/test_python_boilerplate.py'),
      this.destinationPath(path.join(this.destinationRoot(), 'utests/test_python_boilerplate.py'))
    )

    // cp dot files
    this.fs.copyTpl(
      this.templatePath('.bumpversion.cfg'),
      this.destinationPath(path.join(this.destinationRoot(), '.bumpversion.cfg')),
      {
        'projectVersion': this.props.projectVersion,
        'projectName': this.props.projectName
      }
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(path.join(this.destinationRoot(), 'CONTRIBUTING.rst')),
      {
        'projectUrl': this.props.projectUrl
      }
    );
